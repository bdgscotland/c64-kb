...
**Instance of:** vertical_shmup, horizontal_shmup
...
`horizontal_shmup` is listed because the recipe's frontmatter scaffolds
it; the listing scrolls vertically (`soft_scroll_v`), and a horizontal
game changes the scroll technique.
