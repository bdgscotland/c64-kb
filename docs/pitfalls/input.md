...
**Triggered by techniques:** joystick_edge_detect, joystick_autorepeat, keyboard_matrix_scan, paddle_read, mouse_1351_read, four_player_read, attract_mode_input_replay, two_player_state_swap
