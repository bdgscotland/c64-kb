...
`cl65 -t c64 -O`, run headless in VICE x64sc 3.10 (PAL, the default C64C:
8565, 8580, 8521; an earlier version said 6569) with the
...
The pictures are evidence about VICE, not about a chip on a bench.
