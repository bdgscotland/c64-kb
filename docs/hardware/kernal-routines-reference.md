...
- `(may; ROM walk from $FFxx)` is an upper bound: every byte `$00-$FF`
  that code reachable from the jump-table slot can store to (STA, STX,
  STY, INC, DEC and the shifts; an indexed store counts its whole index
  range). Error paths count. So does a tape IRQ handler the routine
...
| Entry | May write |
|---|---|
| IRQ `$FF48`, through `$0314` to `$EA31` | $01, $91, $A0-$A2, $C0, $C5-$C6, $CB, $CD-$CF, $F3-$F6 (may; ROM walk from $FF48; also stores through ($D1), ($F3)) |
| NMI `$FE43`, through `$0318` to `$FE47` | $00-$01, $90-$91, $94-$95, $99-$9A, $A3, $A5, $A7-$AB, $B4-$B6, $BD, $C3-$C4, $C6, $CC-$CD, $CF, $D1-$D3, $D5-$D6, $D9-$F4 (may; ROM walk from $FE43; not followed: JMP ($8002), JMP ($A002); also stores through ($C3), ($D1), ($F3), ($F7)) |
...
**Clobbers zero page:** $B7, $BB-$BC (may; ROM walk from $FFBD)
...
**Affects:** A, X, Y, C
**Clobbers zero page:** $01, $90-$96, $98-$9C, $9E-$B1, $B4-$B6, $B9, $BD-$C2, $C5-$C7, $C9, $CB, $CD-$FA (may; ROM walk from $FFC0; also stores through ($AC), ($B2), ($D1), ($F3), ($F9))
...
**Output:** C=0 on success; C=1 on error, A = error code
**Affects:** A, X, Y, C
**Clobbers zero page:** $01, $90-$96, $98-$9C, $9E-$B1, $B4-$B6, $B8-$BA, $BD-$C2, $C5-$C7, $C9, $CB, $CD-$F6, $F8, $FA (may; ROM walk from $FFC3; also stores through ($AC), ($B2), ($D1), ($F3), ($F9))
...
**Output:** C=0 on success; C=1 on error, A = error code
**Affects:** A, X, C
**Clobbers zero page:** $01, $90-$96, $99-$9C, $9E-$B1, $B4-$B6, $B8-$BA, $BD-$C2, $C5-$C7, $C9, $CB, $CD-$F6 (may; ROM walk from $FFC6; also stores through ($AC), ($B2), ($D1), ($F3), ($F9))
...
**Output:** C=0 on success; C=1 on error, A = error code
**Affects:** A, X, C
**Clobbers zero page:** $01, $90-$96, $99-$9C, $9E-$B1, $B4-$B6, $B8-$BA, $BD-$C2, $C5-$C7, $C9, $CB, $CD-$F6 (may; ROM walk from $FFC9; also stores through ($AC), ($B2), ($D1), ($F3), ($F9))
...
**Output:** None
**Affects:** A, X
**Clobbers zero page:** $90, $94-$95, $99-$9A, $A3, $A5 (may; ROM walk from $FFCC)
...
**Output:** None
**Affects:** A, X
**Clobbers zero page:** $90, $94-$95, $98-$9A, $A3, $A5 (may; ROM walk from $FFE7)
**Pairs with:** CLRCHN
...
**Affects:** A, X, Y, C
**Clobbers zero page:** $01, $90-$96, $99-$9C, $9E-$B1, $B4-$B6, $B9, $BD-$C7, $C9, $CB, $CD-$F6 (may; ROM walk from $FFD5; also stores through ($AC), ($AE), ($B2), ($D1), ($F3), ($F9))
...
**Output:** C=0 on success; C=1 on error, A = error code
**Affects:** A, X, Y, C
**Clobbers zero page:** $01, $90-$96, $99-$9C, $9E-$B1, $B4-$B6, $B9, $BD-$C2, $C5-$C7, $C9, $CB, $CD-$F6 (may; ROM walk from $FFD8; also stores through ($AC), ($B2), ($D1), ($F3), ($F9))
**Pairs with:** SETLFS, SETNAM
...
**Clobbers zero page:** $01, $90-$96, $99-$9C, $9E-$B1, $B4-$B6, $BD-$C2, $C5-$C7, $C9, $CB, $CD-$F6 (may; ROM walk from $FFD2; also stores through ($AC), ($B2), ($D1), ($F3), ($F9))
...
**Affects:** A, X, Y, C
**Clobbers zero page:** $01, $90-$97, $99-$9C, $9E-$B1, $B4-$B6, $BD-$C2, $C5-$F6 (may; ROM walk from $FFCF; also stores through ($AC), ($B2), ($D1), ($F3), ($F9))
...
**Affects:** A, X, Y, C
**Clobbers zero page:** $01, $90-$97, $99-$9C, $9E-$B1, $B4-$B6, $BD-$C2, $C5-$C9, $CB-$F6 (may; ROM walk from $FFE4; also stores through ($AC), ($B2), ($D1), ($F3), ($F9))
...
**Affects:** A, X, Y
**Clobbers zero page:** $D1-$D3, $D5-$D6, $F3-$F4 (may; ROM walk from $FFF0)
...
**Output:** None
**Affects:** A, X, Y
**Clobbers zero page:** $99-$9A, $CC-$CD, $CF, $D1-$D3, $D5-$D6, $D9-$F4 (may; ROM walk from $FF81; also stores through ($D1), ($F3))
...
**Clobbers zero page:** $90, $94-$95, $99-$9A, $A3, $A5, $C6 (may; ROM walk from $FFE1)
...
**Clobbers zero page:** $A0-$A2 (may; ROM walk from $FFDB)
...
**Affects:** A, X, Y
**Clobbers zero page:** $A0-$A2 (may; ROM walk from $FFDE)
...
**Output:** None
**Affects:** A, X
**Clobbers zero page:** $91, $A0-$A2 (may; ROM walk from $FFEA)
...
**Affects:** A, X, Y
**Clobbers zero page:** none (may; ROM walk from $FF99)
...
**Affects:** A, X, Y
**Clobbers zero page:** none (may; ROM walk from $FF9C)
...
**Output:** None
**Affects:** A, X, Y
**Clobbers zero page:** $00-$01 (may; ROM walk from $FF84)
...
**Output:** None
**Affects:** A, X, Y
**Clobbers zero page:** $02-$FF (may; ROM walk from $FF87; also stores through ($C1))
...
**Output:** None
**Affects:** A, X, Y
**Clobbers zero page:** $C3-$C4 (may; ROM walk from $FF8A; also stores through ($C3))
...
**Affects:** A, X, Y
**Clobbers zero page:** $C3-$C4 (may; ROM walk from $FF8D; also stores through ($C3))
**Pairs with:** RESTOR
...
**Clobbers zero page:** $90, $9D (may; ROM walk from $FF90)
...
**Affects:** A
**Clobbers zero page:** $90, $94-$95, $A3, $A5 (may; ROM walk from $FFB1)
...
**Output:** None (status byte set on error)
**Affects:** A
**Clobbers zero page:** $90, $94-$95, $A3, $A5 (may; ROM walk from $FFB4)
...
**Output:** None
**Affects:** A
**Clobbers zero page:** $90, $95, $A5 (may; ROM walk from $FF93)
...
**Output:** None
**Affects:** A
**Clobbers zero page:** $90, $95, $A5 (may; ROM walk from $FF96)
...
**Affects:** A
**Clobbers zero page:** $90, $95, $A4-$A5 (may; ROM walk from $FFA5)
...
**Clobbers zero page:** $90, $94-$95, $A5 (may; ROM walk from $FFA8)
...
**Output:** None
**Affects:** A
**Clobbers zero page:** $90, $94-$95, $A3, $A5 (may; ROM walk from $FFAB)
...
**Output:** None
**Affects:** A
**Clobbers zero page:** $90, $94-$95, $A3, $A5 (may; ROM walk from $FFAE)
...
**Affects:** A
**Clobbers zero page:** $90 (may; ROM walk from $FFB7)
...
**Affects:** A, X, Y
**Clobbers zero page:** $C5-$C6, $CB, $F5-$F6 (may; ROM walk from $FF9F)
...
**Output:** None
**Affects:** None
**Clobbers zero page:** none (may; ROM walk from $FFA2)
**Pairs with:** READST
...
**Affects:** X, Y
**Clobbers zero page:** none (may; ROM walk from $FFF3)
**Pairs with:** SCREEN
