...
edges under schema 18; schema 19 adds `REQUIRES` and `MITIGATED_BY`
(15 → 17 edge types, no new label) and needs `npm run ingest:clean`,
after which `npx c64-kb health` prints the live figures.
