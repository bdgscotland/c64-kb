...
## This starter: hello-kick

hello in KickAssembler alone: `src/main.asm` runs the loop, moves sprite 0
and uses the meter's macros (`#import "frame_meter.asm"`). Copy it to start a
pure KickAssembler program. To use it outside c64-kb, copy
`templates/_harness` into `./harness` and set `C64KB` to your c64-kb checkout.
