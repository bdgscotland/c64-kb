...
times each frame. Start a program from it with
`npm run new-project -- hello <dir>` in c64-kb. `PLAN.md` here is a plan
filled from real tool output; new-project keeps it as
`PLAN-hello-example.md` and gives the new program a blank one.
