...
static const char level_text[LEVEL_TH][LEVEL_TW + 1] = {
    ...
    "BWWWWB.BWBWBWBW.BBBBB.BWWWWWB.BWBWBW.BBBBBBBB.BWWWB.BWBWBWB.BBBB",
...
static const char tile_key[] = ".rBWDSLlPKR=";
static const char tile_glyph[][4] = {
    { CH_SKY,   CH_SKY,   CH_SKY,   CH_SKY   },   // .  sky, or a dark alley below the roofs
    ...
    { CH_LAMP,  CH_SKY,   CH_POLE,  CH_SKY   },   // L  an alley lamp
    { CH_POLE,  CH_SKY,   CH_POLE,  CH_SKY   },   // l  its post
