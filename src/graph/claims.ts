...
export const HARDWARE_UNITS: readonly HardwareUnit[] = [
  ...
  { name: "cia1_timer_a", kind: "timer", addresses: "$DC04-$DC05, $DC0E, bit 0 of $DC0D", chip: "CIA1" },
  { name: "cia1_timer_b", kind: "timer", addresses: "$DC06-$DC07, $DC0F, bit 1 of $DC0D", chip: "CIA1" },
  { name: "cia2_timer_a", kind: "timer", addresses: "$DD04-$DD05, $DD0E, bit 0 of $DD0D", chip: "CIA2" },
  { name: "cia2_timer_b", kind: "timer", addresses: "$DD06-$DD07, $DD0F, bit 1 of $DD0D", chip: "CIA2" },
  { name: "cia1_tod", kind: "tod", addresses: "$DC08-$DC0B, bit 2 of $DC0D", chip: "CIA1" },
  { name: "cia2_tod", kind: "tod", addresses: "$DD08-$DD0B, bit 2 of $DD0D", chip: "CIA2" },
  {
    name: "cia1_port_a",
    kind: "port",
