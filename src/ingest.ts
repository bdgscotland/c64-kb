...
async function main() {
  ...
  const archetypeFeaturesRequested = new Set<string>();
  const archetypeRisksRequested = new Set<string>();
  ...
  // An archetype fingerprint or pitfall name that matches no node.
  let archetypeFeaturesDropped = 0;
