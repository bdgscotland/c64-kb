...
# Written to the round-3 brief (summarised in music/README.md): a grammar first (key, progressions, a
...
TUNE = dict(
    ...
    orders=[
        ...
        seq(*[(0, 'l0')] * 4,
            ...
            *[(0, 'l0')] * 4),
        # voice 3: arpeggios and hats, the echo in A3
